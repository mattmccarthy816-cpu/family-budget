...
const Logo = ({ size = 28, color = "#c17f3e" }) => (
  <svg width={size} height={size} viewBox="298 268 395 490" xmlns="http://www.w3.org/2000/svg">
    <path fill={color} d="M298.683685,464.999939 C298.683533,441.221008 298.683533,417.942139 298.683533,394.840485 C301.552399,393.785431 303.084473,395.418274 304.735016,396.342865 C326.229950,408.384613 347.670807,420.523132 369.197632,432.507355 C372.041748,434.090698 373.214569,436.035431 373.210938,439.248993 C373.157318,487.045807 373.161133,534.842712 373.224182,582.639526 C373.228394,585.833313 372.132080,587.840271 369.289612,589.438965 C347.378113,601.762939 325.539520,614.216431 303.676575,626.626770 C302.534088,627.275330 301.457855,628.139954 298.683838,627.632690 C298.683838,573.749878 298.683838,519.624939 298.683685,464.999939" />
    <path fill={color} d="M437.408997,718.640625 C393.395630,692.967102 349.694672,667.483582 306.205627,642.123657 C306.386810,639.374634 308.317291,639.008240 309.639679,638.250122 C331.741943,625.578308 353.899048,613.002075 375.993103,600.316040 C378.610565,598.813171 380.746643,598.814270 383.380371,600.354309 C422.767090,623.384460 462.185791,646.360168 501.657166,669.244873 C505.063293,671.219604 506.453522,673.504395 506.421936,677.567444 C506.229034,702.387695 506.336273,727.210083 506.313171,752.031799 C506.311646,753.662048 506.698730,755.367065 505.202667,757.898560 C482.706635,744.874573 460.214020,731.852600 437.408997,718.640625" />
    <path fill={color} d="M335.114624,367.062408 C391.925568,333.954254 448.423859,301.033813 504.727325,268.226868 C506.878204,270.269348 506.301971,272.035583 506.304688,273.602356 C506.348511,298.767700 506.277954,323.933502 506.411163,349.098267 C506.429413,352.542908 505.287140,354.506348 502.308350,356.230743 C463.814484,378.514557 425.370422,400.884796 386.985535,423.355743 C383.983368,425.113220 381.822266,425.013794 378.817444,423.297638 C357.118561,410.904877 335.291351,398.736938 313.519318,386.471924 C311.970306,385.599335 310.072998,385.133484 308.971466,382.730408 C317.121033,376.884766 326.213379,372.469208 335.114624,367.062408" />
    <path fill={color} d="M536.382629,363.686035 C534.500000,362.500000 528.000000,358.000000 520.835510,354.200000 C519.700000,340.000000 519.700000,305.000000 519.700000,280.000000 C519.700000,272.000000 520.200000,268.800000 520.835510,267.929779 C578.169373,301.343292 635.409546,334.702209 692.377686,367.902588 C692.101562,370.577820 690.456970,370.973999 689.227966,371.691681 C667.507202,384.374878 645.740784,396.980255 624.065674,409.740845 C620.904297,411.601990 618.451172,411.376099 615.342773,409.556732 C589.177917,394.242462 562.919678,379.087738 536.382629,363.686035" />
    <path fill={color} d="M658.049011,678.088867 C612.187073,704.772888 566.645813,731.280945 521.304749,757.672485 C519.040527,755.912292 519.714783,754.110840 519.711853,752.574890 C519.663452,727.433044 519.726074,702.290833 519.615295,677.149414 C519.600586,673.813782 520.451294,671.635437 523.498291,669.873413 C554.473328,651.961060 585.377808,633.926453 616.282654,615.893005 C618.456116,614.624695 620.463501,614.118164 622.812317,615.495361 C645.640259,628.879333 668.493958,642.219299 691.328918,655.591309 C691.729858,655.826111 691.988892,656.303284 693.097778,657.544678 C681.367676,664.424438 669.868652,671.168640 658.049011,678.088867" />
  </svg>
);
...
<div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: entriesOpen ? 14 : 0 }}>
  <div onClick={() => setEntriesOpen(o => !o)} style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", userSelect: "none", flex: 1 }}>
    <span style={{ fontSize: 10, color: C.textLo, fontFamily: "'DM Mono',monospace", letterSpacing: 2 }}>ENTRIES</span>
    <span style={{ fontSize: 10, color: C.borderMid, fontFamily: "'DM Mono',monospace" }}>· TAP TO EDIT</span>
    <span style={{ fontSize: 10, color: C.textLo, fontFamily: "'DM Mono',monospace" }}>{filteredEntries.length !== sortedEntries.length ? `${filteredEntries.length} of ${sortedEntries.length}` : sortedEntries.length}</span>
    ...
    {(filterQuery || filterMember || filterCard) && (
      <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap", paddingTop: 2, borderTop: `1px solid ${C.borderMid}` }}>
        ...
        <button onClick={() => { setFilterQuery(""); setFilterMember(null); setFilterCard(null); }} style={{ background: "none", border: "none", color: C.textLo, fontSize: 11, cursor: "pointer", fontFamily: "'Sora',sans-serif", textDecoration: "underline", textUnderlineOffset: 3, padding: 0 }}>Clear all</button>
                    ...
                    {(isDesktop || entriesOpen) ? (filteredEntries.length === 0 ? (
