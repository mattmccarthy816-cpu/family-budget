    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Sora', sans-serif", color: C.textHi, paddingBottom: 60 }}>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card { background: linear-gradient(160deg, #26200f 0%, #1d1a14 45%, #131109 100%); border: 1px solid ${C.border}; border-radius: 16px; box-shadow: inset 0 1px 0 rgba(193,127,62,0.08); }
