    ...
    {isDesktop ? (
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 52 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontFamily: "'Playfair+Display', serif", fontWeight: 600, fontSize: 16, letterSpacing: "0.035em", color: theme === 'dark' ? "#ffffff" : "#1a1a1a" }}>BRAND</span>
          <div style={{ width: 1.5, height: 22, background: C.accent, borderRadius: 1, opacity: 0.6 }} />
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.55 }}>
            <span style={{ fontFamily: "'Playfair+Display', serif", fontWeight: 400, fontSize: 6.5, letterSpacing: "0.18em", color: theme === 'dark' ? "rgba(255,255,255,0.32)" : "rgba(0,0,0,0.32)" }}>PERSONAL</span>
            <span style={{ fontFamily: "'Playfair+Display', serif", fontWeight: 400, fontSize: 6.5, letterSpacing: "0.18em", color: theme === 'dark' ? "rgba(255,255,255,0.32)" : "rgba(0,0,0,0.32)" }}>FINANCE</span>
          </div>
